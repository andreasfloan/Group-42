...
**Goal:** To develop a tool that enables users to calculate the different structural elements of a project from a BIM model.
...
### 3B: Propose a (Design for a) Tool

**Process Diagram:** The BPMN diagram illustrates the proposed tool for calculating the structural elements of a project from a BIM model.
...
**Functional requirements:** The tool shall be able to:
...
**Non-functional requirements:** The tool shall be:
...
**Business value:** The proposed tool can create significant value for businesses by helping them to:
...
**Societal value:** The proposed tool can also contribute to societal value by helping to:
...
The proposed tool has the potential to offer significant value to both businesses and society by helping to improve the safety, efficiency, and sustainability of construction projects.

In addition to the functional and non-functional requirements listed above, it is also important to consider the following requirements when developing a tool for calculating the different structural elements in a BIM model:

**Interoperability:** The tool should be interoperable with different BIM software applications. This will allow users to use the tool with their preferred BIM software, as well as it works as a safety measure to compare different data.

**Security:** The tool should be secure to protect users' data from unauthorized access and modification.

**Customization:** The tool should be customizable to meet the specific needs of different users and organizations.

By meeting these requirements, a tool for calculating the different structural elements in a BIM model can be a valuable asset for businesses and organizations involved in the design, construction, and operation of buildings and other infrastructure.
